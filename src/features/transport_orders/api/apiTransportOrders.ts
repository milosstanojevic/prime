...
) => usePost<TransportOrder[], TransportOrder>(pathToUrl(mainEntityUrl), undefined, updater);
...
export const useEditTransportOrder = (
    updater?: (oldData: TransportOrder[], newData: TransportOrder) => TransportOrder[],
    params?: object
) => usePut<TransportOrder[], TransportOrder>(pathToUrl(mainEntityUrl), params, updater);

export const useDeleteTransportOrder = (
    updater: (oldData: TransportOrder[], deletedId: string | number) => TransportOrder[]
