...
export const RegalPositionForm: FC<IRegalPositionForm> = ({
  className,
  onSubmit,
  onCancel,
  regalPosition = {},
}) => {
  const [regalPositionForm, setRegalPositionForm] = useState({ ...initialFormState, ...regalPosition })
  ...
  return (
    <form className={`${styles.regal_position_form_wrapper} ${className}`} onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
