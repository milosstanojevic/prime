...
export const getAllTransportDestinationArticles = (state: RootState) =>
  state.transport_destination_articles.items;
export const getTransportDestinationArticleIds = (state: RootState) =>
  state.transport_destination_articles.itemIds;
  ...
  return createSelector(
    ...
    (transportDestinationArticles, id) => {
      ...
      transportDestinationArticles.forEach((transportDestinationArticle) => {
        if (
          transportDestinationArticle &&
          transportDestinationArticle.transportDestinationId === id
        ) {
