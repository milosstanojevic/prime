...
import { WarehouseRegalPositionProvider, RegalPositionItem } from '../../warehouse_regal_positions';
...
export const RegalPage: React.FC<IRegalPage> = ({
    ...
    const mutateAdd = useAddRegalPosition(regalId, (oldData, newData) => [...oldData, newData]);
        ...
        <>
            ...
            <Modal open={show} onClose={handleCloseModal}>
                <Bubble className={styles.regal_position_modal}>
                    ...
                    <RegalPositionForm onCancel={handleCloseModal} onSubmit={handleSubmit} />
                </Bubble>
            </Modal>
        </>
    );
