...
export const useGetMerchants = () => useFetch<Merchant[]>(pathToUrl(mainEntityUrl));

export const useAddMerchant = (updater: (oldData: Merchant[], newData: Merchant) => Merchant[]) =>
...
export const useEditMerchant = (updater: (oldData: Merchant[], newData: Merchant) => Merchant[]) =>
