...
export const TransportArticleQtyInput: React.FC<TransportArticleQtyInputProps> = (params) => {
    const { data: warehouseArticle, isLoading } = useGetWarehouseArticleByParams(params);
