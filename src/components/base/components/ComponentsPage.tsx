...
const ComponentsPage: React.FC = () => {
    ...
    const [selectMultipleIds, setSelectMultipleIds] = React.useState<Array<number | string>>([]);
    ...
    const handleMultipleSelectChange = React.useCallback((ids: Array<string | number>) => {
